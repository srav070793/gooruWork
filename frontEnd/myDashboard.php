...
.fixed-plugin {
  top: 120px; }
#usersCategory, #newUsersCategory, #eventsCategory{
  cursor: pointer;
}
...
<script type = "text/javascript">
  ...
  function drawAxisTickColors(category='users', timePeriod='day') {
      ...
      //font color: #3C4858 font-family: "Roboto", "Helevetica", "Arial", "sans-serif"
      var options = {
        hAxis: {
          title: timePeriod,
          textStyle: {
            ...
            fontSize: 20,
            //fontName: 'Arial',
            fontName: "Roboto, Helevetica, Arial, sans-serif",
            bold: false,
            italic: false
          },
          titleTextStyle: {
  ...
  function loadGraph(htmlelement){
    var categoryCollected = "users";
    var timePeriodCollected = "none";

    var dayButton = document.getElementById("dayBtn");
    var weekButton = document.getElementById("weekBtn");
    var monthButton = document.getElementById("monthBtn");
    
    var usersDiv = document.getElementById('usersCategory');
    var newUsersDiv = document.getElementById('newUsersCategory');
    var eventsDiv = document.getElementById('eventsCategory');
    
    var graphTitle = document.getElementById("graphTitle");

    //initialize the timePeriod to the previously active value
    if(dayButton.className == "btn btn-success"){
      timePeriodCollected = 'day';
    }
    else if(weekButton.className == "btn btn-success"){
      timePeriodCollected = 'week';
    }

    else if(monthButton.className == 'btn btn-success'){
      timePeriodCollected = 'month';
    }

    //initialize the category to previously active value
    if(usersDiv.className == "col-lg-3 col-md-6 col-sm-6 active"){
      categoryCollected = 'users';
    }
    else if(newUsersDiv.className == "col-lg-3 col-md-6 col-sm-6 active"){
      categoryCollected = 'new users';
    }
    else if(eventsDiv.className == 'col-lg-3 col-md-6 col-sm-6 active'){
      categoryCollected = 'events';
    }

    //update the category or timeperiod to the current calling element
    if(htmlelement.id == 'dayBtn'){
      timePeriodCollected = 'day';

      dayButton.className = "btn btn-success";
      weekButton.className = "btn btn-default";
      monthButton.className = "btn btn-default";

      graphTitle.innerHTML = "Total number of "+ categoryCollected +" per day";
    }
    else if(htmlelement.id == 'weekBtn'){
      timePeriodCollected ="week";

      dayButton.className = "btn btn-default";
      weekButton.className = "btn btn-success";
      monthButton.className = "btn btn-default";

      graphTitle.innerHTML = "Total number of "+ categoryCollected +" per week";
    }
    else if(htmlelement.id == 'monthBtn'){
      timePeriodCollected ="month";

      dayButton.className = "btn btn-default";
      weekButton.className = "btn btn-default";
      monthButton.className = "btn btn-success";

      graphTitle.innerHTML = "Total number of "+ categoryCollected +" per month";
    }
    else if(htmlelement.id == 'usersCategory'){
      categoryCollected = 'users';

      usersDiv.className = 'col-lg-3 col-md-6 col-sm-6 active';
      newUsersDiv.className = "col-lg-3 col-md-6 col-sm-6 inactive";
      eventsDiv.className = "col-lg-3 col-md-6 col-sm-6 inactive";

      graphTitle.innerHTML = "Total number of users per "+timePeriodCollected;
    }
    else if(htmlelement.id == 'newUsersCategory'){
      categoryCollected = 'new users';

      usersDiv.className = 'col-lg-3 col-md-6 col-sm-6 inative';
      newUsersDiv.className = "col-lg-3 col-md-6 col-sm-6 active";
      eventsDiv.className = "col-lg-3 col-md-6 col-sm-6 inactive";

      graphTitle.innerHTML = "Total number of new users per "+timePeriodCollected;
    }
    else if(htmlelement.id == 'eventsCategory'){
      categoryCollected = 'events';

      usersDiv.className = 'col-lg-3 col-md-6 col-sm-6 inactive';
      newUsersDiv.className = "col-lg-3 col-md-6 col-sm-6 inactive";
      eventsDiv.className = "col-lg-3 col-md-6 col-sm-6 active";

      graphTitle.innerHTML = "Total number of events per "+timePeriodCollected;
    }

    //call the graph function with the given cateogry and timePeriod
    drawAxisTickColors(categoryCollected,timePeriodCollected);
  }
</script>
</head>
	<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div id = "usersCategory" class="col-lg-3 col-md-6 col-sm-6 active" onclick = "loadGraph(this)">
            ...
            <div id= "newUsersCategory" class="col-lg-3 col-md-6 col-sm-6 inactive" onclick = "loadGraph(this)">
                <div class="card card-stats">
            ...
            <div id = "eventsCategory" class="col-lg-3 col-md-6 col-sm-6 inactive" onclick = "loadGraph(this)">
                <div class="card card-stats">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div id = "timelineControls">
                          <button id = "dayBtn" class="btn btn-success" onclick = "loadGraph(this)">Day</button>
                          <button  id ="weekBtn" class="btn btn-default" onclick = "loadGraph(this)">Week</button>
                          <button id = "monthBtn" class="btn btn-default" onclick = "loadGraph(this)">Month</button>
                    </div>
                    <div class="card-content">
                        <h4 class="card-title" id ="graphTitle">{{ graphTitle }} {{ graphPeriod }}</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <!--display the chart accordingly-->
                                <div id="chart_div" style="overflow: auto;height: 100%"></div>
                            </div>
                        </div>
                    </div>
                </div>
